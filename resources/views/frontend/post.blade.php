            ...
            <div class="carousel-item {{ $idex == 0 ? 'active' : '' }}">
                <div class="card">
                    ...
                    <div class="description">
                        <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum doloremque facere distinctio,
                            voluptates numquam sunt eligendi dignissimos cum repudiandae explicabo, excepturi doloribus
                            eaque veritatis animi laudantium illum vero iusto qui?</span>
                    </div>
                </div>
            </div>
        @endforeach
