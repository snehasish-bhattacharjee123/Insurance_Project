<div wire:ignore.self class="modal fade" id="AddAbout" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Admin About</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" wire:click="resetField()" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form wire:submit.prevent="store()">
              ...
              <div class="col-md-12 my-4">
                ...
                <input type="number" class="form-control" wire:model="about_contact" oninput="this.value = this.value.slice(0,10)"> 
                @error('about_contact') 
                    <span class="text text-danger">{{$message}}</span>  
                @enderror
...
<div wire:ignore.self class="modal fade" id="editExp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Admin About</h1>
