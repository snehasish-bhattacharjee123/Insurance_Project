<div>
    ...
    <div wire:ignore.self class="modal fade" id="DeleteExp" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="card-header">
                    <h2>
                        ...
                        <a href="#" class="btn btn-primary float-end btn-sm" data-bs-toggle="modal"
                            data-bs-target="#AddAbout">Add Experience</a>
                    </h2>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($about as $a)
                                <tr>
                                    ...
                                    <td>
                                        @if (!empty($image))
                                            <img src="{{ asset('storage/about/' . $image[0]) }}"
                                    ...
                                    <td>
                                        <button wire:click="delete({{ $a->id }})" class="btn btn-danger"
                                            data-bs-toggle="modal" data-bs-target="#DeleteExp">Delete</button>
                                        <button wire:click="edit({{ $a->id }})" class="btn btn-success"
                                            data-bs-toggle="modal" data-bs-target="#editExp">Edit</button>
                                    </td>
